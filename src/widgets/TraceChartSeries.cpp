...
struct TraceChartSeries::pimpl {
    void setData(cv::Mat data, double offset, NORMALIZATION norm);
    void updatePoly();
    void updateYExtents();
...
TraceChartSeries::~TraceChartSeries() = default;
TraceChartSeries::TraceChartSeries(cv::Mat data, double xmin, double xmax, double offset, NORMALIZATION norm) {
    setXMin(xmin);
    setXMax(xmax);
    setData(data, offset, norm);
}
void TraceChartSeries::setData(cv::Mat data, double offset, NORMALIZATION norm) {
    impl->setData(data, offset, norm);
}
...
// pimpl
void TraceChartSeries::pimpl::setData(cv::Mat d, double offset, NORMALIZATION norm) {
    qDebug() << "ddepth" << d.depth();
...
void TraceChartSeries::pimpl::updatePoly() {
    ...
    qDebug() << "Series updatePoly in data@0" << data.at<double>(0);
